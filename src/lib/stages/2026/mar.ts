...
export const mar2026: Stage[] = [
  ...
  },
  {
    ...
    ['orange', 'orange', 'orange', 'blue'  , 'blue'  , 'green' , 'blue'  , 'blue'  ],
    ['blue'  , 'orange', 'blue'  , 'blue'  , 'green' , 'green' , 'green' , 'blue'  ],
    ['blue'  , 'blue'  , 'blue'  , 'blue'  , 'blue'  , 'green' , 'blue'  , 'blue'  ],
    ['blue'  , 'blue'  , 'grey'  , 'blue'  , 'blue'  , 'red'   , 'red'   , 'red'   ],
    ['blue'  , 'grey'  , 'grey'  , 'grey'  , 'blue'  , 'red'   , 'yellow', 'red'   ],
    ['blue'  , 'blue'  , 'grey'  , 'blue'  , 'blue'  , 'yellow', 'yellow', 'yellow'],
    ['blue'  , 'blue'  , 'blue'  , 'blue'  , 'blue'  , 'blue'  , 'yellow', 'brown' ]
  ],
  },

  {
    ...
    size: 7,
    grid: [
    ['purple', 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'blue'  , 'blue'  ],
    ['grey'  , 'grey'  , 'orange', 'orange', 'grey'  , 'grey'  , 'blue'  ],
    ['grey'  , 'orange', 'orange', 'orange', 'orange', 'grey'  , 'blue'  ],
    ['grey'  , 'orange', 'yellow', 'yellow', 'orange', 'grey'  , 'blue'  ],
    ['grey'  , 'grey'  , 'green' , 'yellow', 'yellow', 'yellow', 'blue'  ],
    ['red'   , 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'yellow', 'yellow'],
    ...
    size: 7,
    grid: [
    ['orange', 'orange', 'orange', 'green' , 'green' , 'green' , 'blue'  ],
    ...
    ['green' , 'green' , 'purple', 'purple', 'green' , 'green' , 'green' ],
    ['green' , 'grey'  , 'grey'  , 'red'   , 'green' , 'green' , 'green' ],
    ['green' , 'green' , 'green' , 'red'   , 'red'   , 'green' , 'green' ]
  ],
  },

  {
    ...
    size: 8,
    grid: [
    ['brown' , 'brown' , 'red'   , 'red'   , 'red'   , 'red'   , 'red'   , 'red'   ],
    ['brown' , 'red'   , 'red'   , 'grey'  , 'yellow', 'yellow', 'yellow', 'red'   ],
    ['brown' , 'red'   , 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'yellow', 'yellow'],
    ['brown' , 'brown' , 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'green' ],
    ['orange', 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'green' , 'green' ],      
    ['orange', 'orange', 'grey'  , 'grey'  , 'grey'  , 'grey'  , 'green' , 'blue'  ],      
    ['purple', 'orange', 'orange', 'orange', 'grey'  , 'green' , 'green' , 'blue'  ],      
    ['purple', 'purple', 'purple', 'green' , 'green' , 'green' , 'blue'  , 'blue'  ]       
  ],
  },
]