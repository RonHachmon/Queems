...
export default function StageSelectPage() {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className="flex flex-col items-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4 sm:px-8 py-10 gap-8"
    >
      {/* Header */}
      <div className="flex flex-col items-center gap-2">
        <div className="flex items-center gap-2">
          <Crown className="w-8 h-8 text-amber-400" strokeWidth={1.5} />
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">Queems</h1>
        </div>
      ...
      <div
        ...
        className="flex items-center gap-1 bg-gray-100 dark:bg-gray-800 rounded-full p-1"
      >
        <button
          type="button"
          role="tab"
      ...
      {activeTab === 'settings' && (
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div className="flex items-center justify-between gap-4 px-5 py-4 min-h-[64px]">
              <div className="flex flex-col gap-0.5">
                <span className="text-sm font-medium text-gray-800 dark:text-gray-200">Auto-mark invalid cells</span>
              ...
              <button
                ...
                className={cn(
                  ...
                  autoMarkEnabled ? 'bg-amber-400' : 'bg-gray-200 dark:bg-gray-600',
                )}
              >
                <span
                  className={cn(
          ...
          <p className="mt-3 text-xs text-gray-400 dark:text-gray-500 text-center px-2">
